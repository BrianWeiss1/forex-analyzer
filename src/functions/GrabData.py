...
def GrabCloseData(symbol, api_key='YOUR_API_KEY2'):
    ...
    endpoint = f'https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol={symbol}&interval=1min&apikey={api_key}&month=2009-01&outputsize=full'
